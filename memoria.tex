...
En este primer paso, re-escribiremos la aplicación de Java para que no haga uso de ningun framework de test, aunque seguiremos usando el toolkit Vert.x para gestionar los callbacks de las pruebas.
