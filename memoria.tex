...
\url{https://github.com/TFG-DistributedWebChat}
...
No debe confundirse un mensaje de chat con un mensaje de conexión, la forma de diferenciarlos es por la existencia o no de la clave \textit{message} en el JSON.
