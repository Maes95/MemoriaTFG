...
\begin{itemize}
	...
	\begin{itemize}
		\item Un nuevo mensaje del cliente llega desde el WebSocket y ejecuta el método bajo la anotación \textit{@OnMessage}. Este mensaje será enviado al \textit{Exchange}, que se ocupará de distribuir dicho mensaje a todas las colas de otros usuarios, siendo el topic de este envío su sala de chat.
\begin{lstlisting}[language=Java]
