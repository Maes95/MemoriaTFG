...
El modelo de desarrollo de este proyecto se ha llevado a cabo a través de TDD\footnote{\url{https://es.wikipedia.org/wiki/Desarrollo_guiado_por_pruebas}}(Test-driven Development, o en español, desarrollo guiado por pruebas, ver figura~\ref{figura:tdd}), una práctica de Ingeniería del Software cuya principal idea es hacer que los requistos sean traducidos a pruebas.
...
El proyecto seguirá la arquitectura planteada en figura~\ref{figura:design}.
